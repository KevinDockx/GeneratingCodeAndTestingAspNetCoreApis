            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0", new Info
                    {
                        Version = "1.0",
                        Title = "Library API",
                        Description = "Library API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
                           Name = "Kevin Dockx",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0/swagger.json", "Library API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "Library API Original");
                });
